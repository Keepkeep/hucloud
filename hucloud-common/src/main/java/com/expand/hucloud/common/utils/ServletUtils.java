...
public class ServletUtils {
    ...
    public static String renderString(HttpServletResponse response, String string) {
        try {
            ...
            response.setCharacterEncoding(AppConstant.UTF_ENCODING);
    ...
    public static void setExportResponse(HttpServletResponse response, String fileName, Integer size) throws UnsupportedEncodingException {
        ...
        response.setHeader("Content-Disposition", HttpUtil.safeHttpHeader("attachment;filename=" + URLEncoder.encode(fileName, AppConstant.UTF_ENCODING)));
