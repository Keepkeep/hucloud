...
public class HttpUtil {
    ...
    public static void ajaxStatus(HttpServletResponse response, int status, String tip) {
        try {
            response.setContentType("text/html;charset=" + AppConstant.UTF_ENCODING);
    ...
    public static String encodeRetURL(String url, String retParam, String retUrl, Map<String, String> data) {
        ...
        retStr.append("=");
        try {
            retStr.append(URLEncoder.encode(retUrl, AppConstant.UTF_ENCODING));
    ...
    public static String decodeURL(String url) {
        ...
        try {
            retUrl = URLDecoder.decode(url, AppConstant.UTF_ENCODING);
        } catch (UnsupportedEncodingException e) {
            log.error("encodeRetURL error." + url);
        }
